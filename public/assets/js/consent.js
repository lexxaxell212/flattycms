(function () {
 ...
 async function saveConsent(rejectAll = false, clickedBtn = null, silent = false) {
  ...
  if (clickedBtn) {
   clickedBtn.disabled = true; clickedBtn.innerHTML = '<div class="btn-fetch"><span></span><span></span><span></span></div>';
  }
  if (btnDismiss) {
  ...
  try {
   ...
   if (clickedBtn) {
    clickedBtn.disabled = false; clickedBtn.innerHTML = originalHTML;
   }
   if (btnDismiss) {
 ...
 document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("btnDismissConsent")?.addEventListener("click", function () {
   saveConsent(true, null, true);
  });
  document.getElementById("btnAcceptConsent")?.addEventListener("click", function () {
   saveConsent(false, this);
  });
  document.getElementById("btnRejectConsent")?.addEventListener("click", function () {
   saveConsent(true, this);
  });
 });
})();