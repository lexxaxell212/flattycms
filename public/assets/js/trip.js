...
(function () {
    ...
    matches.forEach((p) => {
      ...
      btn.addEventListener("click", () => {
        ...
        document.getElementById("startImg").innerHTML = startPoint.poi_image
          ? `<img src="${escHtml(startPoint.poi_image)}" class="card-img-top" onerror="this.src='/assets/images/default-poi.png'">`
          : `<img src="/assets/images/default-poi.png" class="card-img-top">`;
  ...
  function updatePlannerUI() {
    ...
    list.innerHTML = routes
      ...
      ${
        r.poi_image
          ? `<img src="${escHtml(r.poi_image)}" class="card-img-top" onerror="this.src='/assets/images/default-poi.png'">`
          : `<img src="/assets/images/default-poi.png" class="card-img-top">`
      }
      <div class="card-body">
...
document.getElementById("startImg").innerHTML = matchedPoi?.poi_image
  ? `<img src="${escHtml(matchedPoi.poi_image)}" class="card-img-top" onerror="this.src='/assets/images/default-poi.png'">`
  : `<img src="/assets/images/default-poi.png" class="card-img-top">`;
  ...
  function loadExplorePoi() {
    ...
    function render() {
      ...
      wrap.innerHTML = limited
        ...
        ${
          poi.poi_image
            ? `<img src="${escHtml(poi.poi_image)}" class="card-img" onerror="this.src='/assets/images/default-poi.png'">`
            : `<img src="/assets/images/default-poi.png" class="card-img">`
        }
