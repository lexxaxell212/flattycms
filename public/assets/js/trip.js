...
(function () {
 ...
 function searchStartPoint(q) {
  ...
  matches.forEach((p) => {
   ...
   btn.addEventListener("click", () => {
    ...
    ? `<img src="${escHtml(startPoint.poi_image)}" class="card-img-top" onerror="this.src='/assets/images/default-poi.png'">`: `<img src="/assets/images/default-poi.png" class="card-img-top">`;
 ...
 function updatePlannerUI() {
  ...
  .map(
   ...
   ${
   r.poi_image
   ? `<img src="${escHtml(r.poi_image)}" class="card-img-top" onerror="this.src='/assets/images/default-poi.png'">`: `<img src="/assets/images/default-poi.png" class="card-img-top">`
   }
   <div class="card-body">
 ...
 window.loadTripById = async function (id) {
  try {
   ...
   ? `<img src="${escHtml(matchedPoi.poi_image)}" class="card-img-top" onerror="this.src='/assets/images/default-poi.png'">`: `<img src="/assets/images/default-poi.png" class="card-img-top">`;
 ...
 window.deleteTripById = async function (id,
  title) {
  flattyConfirm(`Hapus trip "${title}"?`,
   async () => {
    const fd = new FormData();
 ...
 function loadExplorePoi() {
  ...
  function render() {
   ...
   .map(
    ...
    ${
    poi.poi_image
    ? `<img src="${escHtml(poi.poi_image)}" class="card-img" onerror="this.src='/assets/images/default-poi.png'">`: `<img src="/assets/images/default-poi.png" class="card-img">`
    }
 ...
 async function loadTripku() {
  ...
  .then((data) => {
   ...
   .map((trip) => {
    ...
    const badge = isAi
    ? `<span class="badge badge-accent me-2" style="font-size:.7rem"><i class="fas fa-wand-magic-sparkles me-1"></i>Itinerary</span>`: `<span class="badge badge-blue me-2" style="font-size:.7rem"><i class="fas fa-route me-1"></i>Classic</span>`;
    const openBtn = isAi
    ? `<button class="btn btn-primary btn-fit" onclick="window.renderAiItinerary(${trip.id})">Buka<i class="fa-solid fa-wand-magic-sparkles ms-1"></i></button>`: `<button class="btn btn-primary btn-fit" onclick="loadSavedTrip(${trip.id})">Buka<i class="fa-solid fa-route ms-1"></i></button>`;
    return `
    <div class="card card-flatty">
    <div class="card-body">
