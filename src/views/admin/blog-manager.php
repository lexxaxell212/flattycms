   ...
   <div class="py-3 px-4">
    ...
    <form method="POST" enctype="multipart/form-data">
     ...
     <div class="col-12 mb-4">
      ...
      <textarea name="copyright" class="form-control" rows="4" placeholder="Nama / Sumber gambar..."><?= safe_html($edit_post['copyright'] ?? '') ?></textarea>
     </div>
  ...
  <div class="card card-flatty mb-4">
   ...
   <div class="px-4 py-3 d-none">
    <form method="POST" enctype="multipart/form-data">
     ...
     <div class="mb-3">
      <label class="form-label fw-medium">Copyright <span class="text-muted fw-normal">*</span></label>
      <textarea name="copyright" class="form-control" rows="4" placeholder="Nama / Sumber gambar..."></textarea>
     </div>
