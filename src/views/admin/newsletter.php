...
<main class="main-content">
  <div class="container">
    <div class="page-header text-center">
      <h1>Newsletter <em class="styled">Manager</em></h1>
    </div>
    <div class="mx-auto" style="max-width:740px">
      ...
      <div class="card card-glass mb-4">
        ...
        <div class="card-body px-4 py-3">
          <form class="text-start" method="POST" action="/admin/newsletter">
      ...
      <div class="row g-3 mb-4 justify-content-center">
        <div class="col-6 col-md-3">
          <div class="card card-glass text-center py-3">
      ...
      <!-- Riwayat -->
      <div class="card card-glass mb-4" id="history">
        <div class="card-header py-3 px-4">
          <div class="d-flex align-items-center gap-2">
            <span class="bg-primary bg-opacity-10 text-primary rounded p-1 lh-1">
      ...
      <!-- Subscribers -->
      <div class="card card-glass" id="subscribers">
        <div class="card-header py-3 px-4">
          <div class="d-flex align-items-center gap-2">
            <span class="bg-primary bg-opacity-10 text-primary rounded p-1 lh-1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form class="border-0 m-0 p-0" method="POST" action="/admin/newsletter"
                    onsubmit="return confirm('Hapus subscriber ini?')">
                    <input type="hidden" name="csrf_token" value="<?= $csrf ?>">
                    <input type="hidden" name="id" value="<?= (int)$s['id'] ?>">
                    <button type="submit" name="delete_subscriber" class="btn btn-danger btn-fit">
