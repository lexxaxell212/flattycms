    ...
    <div class="gal-hero">
      ...
      <div class="gal-hero__actions">
        ...
        <button class="btn btn-primary" id="btnOpenReview">
          <i class="fas fa-pen-to-square"></i> Tulis Review
        </button>
        <?php if (!$is_logged): ?>
    ...
    <div class="bg-surface">
      <div class="gal-search-block">
        <div class="gal-search-wrap">
          ...
          <input type="text" id="searchPoiFilter" class="gal-search-input" placeholder="Cari dari POI...">
          ...
          <div id="tab-gallery">
            <div class="row g-4" id="galleryGrid">
              <div class="col-12 text-center text-muted py-5">
                <i class="fas fa-circle-notch fa-spin fa-2x mb-3 d-block"></i>Memuat foto...
              </div>
            </div>
          ...
          <div id="tab-review" style="display:none">
            <div id="reviewGrid" class="gal-review-grid">
              <div class="text-center text-muted py-5">
                <i class="fa-solid fa-circle-notch fa-spin fa-2x mb-3 d-block"></i>Memuat review...
              </div>
            </div>
...
<div id="uploadModal" class="gal-modal-overlay" style="display:none">
  <div class="gal-modal">
    ...
    <div class="gal-modal__body">
      <div class="gal-field">
        <label class="gal-label">Lokasi Foto<span class="text-danger">*</span></label>
        <div class="gal-search-field-wrap">
          <input type="text" id="uploadPoiSearch" class="gal-input" placeholder="Cari nama POI...">
      ...
      <div class="gal-field">
        ...
        <label class="gal-file-label" id="uploadFileLabel">
          ...
          <span class="gal-file-hint">JPG, PNG, WebP</span>
        </label>
      ...
      <div class="gal-field">
        ...
        <input type="text" id="uploadCredit" class="gal-input" placeholder="Nama / Instagram / Link...">
      </div>
    </div>
    <div class="gal-modal__footer">
      <button class="btn btn-outline-primary" id="btnBatalUpload2">Batalkan</button>
  ...
  <div class="gal-modal">
    ...
    <div class="gal-modal__body">
      <div class="gal-field">
        ...
        <div class="gal-search-field-wrap">
          <input type="text" id="reviewPoiSearch" class="gal-input" placeholder="Cari nama POI...">
      ...
      <div class="gal-field">
        ...
        <input type="text" id="reviewJudul" class="gal-input" placeholder="Judul review...">
      </div>
      <div class="gal-field">
        <label class="gal-label">Review <span class="text-danger">*</span></label>
        <textarea id="reviewCerita" class="gal-input gal-textarea" placeholder="Ceritakan pengalamanmu..." rows="4"></textarea>
      </div>
    </div>
    <div class="gal-modal__footer">
      <button class="btn btn-outline-primary" id="btnBatalReview2">Batalkan</button>
