          ...
          <div class="tp-profile-card">
            ...
            <div class="tp-profile-info">
              ...
              <div class="trip-count">
                Trip tersimpan : <span id="profileTripCount">-</span>
              </div>
            </div>
            <?php else : ?>
        ...
        <div class="tp-content">
          <div id="tab-explore" class="tp-tab-content">
            <div class="input-group mb-4">
              ...
              <input type="text" id="exploreSearch" class="form-control" placeholder="Cari...">
            </div>
          ...
          <div id="tab-tripku" class="tp-tab-content" style="display:none">
            ...
            <div class="tp-empty-state">
              ...
              <a href="/login" class="btn btn-primary btn-sm mt-3">Masuk</a>
            </div>
            <?php endif; ?>
          </div>
              ...
              <div class="mx-auto" style="max-width:740px">
                ...
                <div class="tp-search-wrap">
                  <div class="input-group">
                    ...
                    <input type="text" id="searchPoi" class="form-control" placeholder="Cari POI...">
                  </div>
                ...
                <div class="tp-planner-body mx-auto">
                  <div class="tp-start-section mb-3">
                    <div class="tp-section-label">
                      <div class="d-flex flex-row mb-2">
                        ...
                        <span class="h5 my-auto ms-2">Titik Awal</span>
                      </div>
                    </div>
                    <div class="input-group mb-4">
                      <span class="input-group-text">
                  ...
                  <div class="tp-section-label mt-4">
                    <div class="d-flex flex-row mb-2">
                      ...
                      <span class="h5 my-auto ms-2">Rute POI</span>
                    </div>
                  </div>
                  ...
                  <div id="distanceInfo" class="alert alert-primary py-2 px-3 small mb-4" style="display:none;width:fit-content">
                    <i class="fa-solid fa-ruler me-2"></i>Total jarak: <strong id="totalDist">0</strong> km
                  ...
                  <div class="tp-action-row">
                    ...
                    <?php if ($is_logged): ?>
                    <button class="btn btn-outline-success btn-sm" id="btnSaveTrip" disabled>
                  ...
                  <div id="saveForm" style="display:none">
                    <div class="d-flex flex-row mb-3">
                      ...
                      <span class="h5 my-auto ms-2">Simpan Rute</span>
                    </div>
                    <input type="text" id="tripTitle" class="form-control mb-3" placeholder="Nama trip (opsional)" value="Trip Bandungku">
                    <button class="btn btn-success btn-sm" id="btnConfirmSave">
                      <i class="fa-solid fa-floppy-disk me-1"></i>Simpan
                    </button>
                  </div>
                  <?php endif; ?>
          ...
          <div id="tab-ai" class="tp-tab-content" style="display:none">
            <div class="rounded-lg py-4 bg-surface mx-auto mb-5" style="max-width:740px">
              <div class="mb-4">
                <h2 class="text-center">Surprise Me<em><i>!</i></em>
                </h2>
              </div>
              <p class="fw-semibold small text-muted mb-1 text-center">
                Quick Picks
              </p>
              ...
              <div class="d-flex justify-content-center flex-column">
                ...
                <a id="btnGenerateAI" class="btn btn-primary mx-auto">Buat Itinerary<i class="fas fa-wand-magic-sparkles ms-1"></i></a>
              </div>
              <div id="aiLoader" class="text-center py-4 text-muted small" style="display:none">
                <i class="fa-solid fa-circle-notch fa-spin me-1"></i>Tunggu sebentar...
              </div>
            </div>
      ...
      <div class="modal-content border-0 shadow-lg" style="border-radius:1rem;overflow:hidden">
        <div class="modal-header border-bottom py-3 px-4">
          <h5 class="modal-title fw-semibold mb-0">
            <i class="fas fa-camera me-2 text-primary"></i>Upload Foto
          </h5>
        ...
        <div class="modal-body p-4">
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="text" id="uploadPoiSearch" class="form-control" placeholder="Cari lokasi foto...">
            </div>
