    ...
    <div class="row g-4">
      <div class="col-12">
        <div class="text-muted small d-flex flex-wrap align-items-center gap-2">
          ...
          <span class="text-muted"><i class="fas fa-eye"></i><?= number_format((int) $post["views"]) ?></span>
      ...
      <div class="col-12">
        <img src="<?= BASE_UPLOAD_URL . htmlspecialchars($p['image'] ?? '', ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='/uploads/default.jpg'" alt="<?= htmlspecialchars($post['title'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="w-100 d-block mx-auto rounded-lg" style="max-width: 600px">
      </div>
      <div class="col-12">
        <section>
        ...
        <div style="position:sticky !important; top:82px; align-self:flex-start;">
          <div class="cat-panel">
            ...
            <a href="/blogs/?cat=<?= (int) ($cat["id"] ?? 0) ?>"
              class="d-flex justify-content-between align-items-center py-2 border-bottom cat-link <?= (int) ($cat["id"] ?? 0) === $cat_id ? "fw-bold" : "text-card" ?>">
