...
<main class="main-content">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-12">
        <img src="<?= BASE_UPLOAD_URL . htmlspecialchars($p['image'] ?? '', ENT_QUOTES, 'UTF-8') ?>" onerror="this.onerror=null;this.src='/uploads/default.jpg'" alt="<?= htmlspecialchars($p['title'] ?? '', ENT_QUOTES, 'UTF-8') ?>" class="w-100 d-block mx-auto rounded-lg" style="max-width: 600px">
      </div>
      <div class="col-12">
        <section>
