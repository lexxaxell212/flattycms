...
<head>
  ...
  <?php endif; ?>
  <style>body {visibility: hidden;}#page-loader {position: fixed;top: 0;left: 0;width: 40%;height: 1px;background: #7c3aed;z-index: 9999;transition: width 0.3s ease,opacity 0.3s ease;}</style>
</head>
<body>
