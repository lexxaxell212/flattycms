...
<div class="container">
  ...
  <div class="row g-4 py-5">
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass h-100 overflow-hidden">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Angklung Bandung">
        <div class="card-body">
          <h3>Angklung</h3>
          <p class="text-muted">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass h-100 overflow-hidden">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Calung">
        <div class="card-body">
          <h3>Calung</h3>
          <p class="text-muted">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass overflow-hidden h-100">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Kendang">
        <div class="card-body">
          <h3>Kendang</h3>
          <p class="text-muted">
  ...
  <div class="row g-4 py-5">
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass overflow-hidden h-100">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Jaipong">
        <div class="card-body">
          <h3>Jaipong</h3>
          <p class="text-muted">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass overflow-hidden h-100">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Kecapi Suling">
        <div class="card-body">
          <h3>Tari Kecapi Suling</h3>
          <p class="text-muted">
  ...
  <section class="py-5">
    <h2>Wayang Golek</h2>
    <div>
      <img class="rounded-lg w-100" src="<?= BASE_UPLOAD_URL ?>default.jpg" alt="Kecapi Suling">
    </div>
    <p>
  ...
  <div class="row g-4 py-5">
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass overflow-hidden h-100">
        <img src="<?php BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Rumah Adat Sunda">
        <div class="card-body">
          <h3>Rumah Adat Sunda</h3>
          <p class="text-muted">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass overflow-hidden h-100">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Batik Bandung">
        <div class="card-body">
          <h3>Batik & Kain</h3>
          <p class="text-muted">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card card-glass overflow-hidden h-100">
        <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img-top" alt="Keramik">
        <div class="card-body">
          <h3>Gerabah & Keramik</h3>
          <p class="text-muted">
