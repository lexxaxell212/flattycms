  ...
  <div class="page-header text-center">
    <div class="page-header-svg">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300">
        <defs>
          <style>
            .envelope-body { fill: var(--icon-3); }
            .envelope-flap { fill: var(--icon-1); }
            .envelope-fold { fill: var(--icon-2); }
            .paper         { fill: var(--icon-2); }
            .mail-lines    { stroke: var(--icon-5); }
            .dot-primary   { fill: var(--bg-primary); }
            .dot-accent    { fill: var(--bg-primary-subtle); }
            @keyframes float {
            ...
            @keyframes paper-out {
              ...
              40%      { opacity: 1; }
              60%, 80% { transform: translateY(-38px); opacity: 1; }
              90%,100% { transform: translateY(-38px); opacity: 0; }
            }
            @keyframes fly {
              0%, 70%  { transform: translate(0, 0) rotate(0deg); opacity: 1; }
              85%      { transform: translate(60px, -30px) rotate(8deg); opacity: 1; }
              95%,100% { transform: translate(120px, -55px) rotate(12deg); opacity: 0; }
            }
            @keyframes trail-dot {
              0%, 70%  { opacity: 0; transform: translateX(0); }
              75%      { opacity: 1; }
              90%,100% { opacity: 0; transform: translateX(30px); }
            }
            @keyframes sparkle {
            ...
            .line1 { stroke-dasharray: 60; animation: line-draw 4s ease 1s infinite; }
            .line2 { stroke-dasharray: 45; animation: line-draw 4s ease 1.2s infinite; }
            .line3 { stroke-dasharray: 30; animation: line-draw 4s ease 1.4s infinite; }
      
            .trail1 { animation: trail-dot 4s ease 1s infinite; }
            .trail2 { animation: trail-dot 4s ease 1.15s infinite; }
            .trail3 { animation: trail-dot 4s ease 1.3s infinite; }
      
            .sp1 { animation: sparkle 4s ease 1.8s infinite; transform-origin: 290px 90px; }
            .sp2 { animation: sparkle 4s ease 2s infinite; transform-origin: 310px 110px; }
            .sp3 { animation: sparkle 4s ease 1.9s infinite; transform-origin: 275px 75px; }
          </style>
        </defs>
        <g class="paper-sheet">
