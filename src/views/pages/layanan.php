          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 280">
            <defs>
              <style>
                ...
                .line-a {
                  fill: none; stroke: var(--icon-3);
                  stroke-width: 4; stroke-linecap: round;
                  stroke-dasharray: 400;
                  animation: draw 2s ease forwards;
                }
                .line-b {
                  fill: none; stroke: var(--icon-2);
                  stroke-width: 4; stroke-linecap: round;
                  stroke-dasharray: 400; stroke-dashoffset: 400;
                  animation: draw 2.3s ease 0.3s forwards;
                }
                .line-c {
                  fill: none; stroke: var(--icon-4);
                  stroke-width: 4; stroke-linecap: round;
                  stroke-dasharray: 400; stroke-dashoffset: 400;
    ...
    <div class="row g-5">
        ...
        <div class="card card-flatty h-100">
          <div class="card-body">
            <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img" alt="default">
                ...
                <p>Evolusi dari Trans Metro Bandung (TMB) dan Teman Bus yang kini terintegrasi dalam sistem Metro Jabar Trans (MJT).</p>
        ...
        <div class="card card-flatty h-100">
          <div class="card-body">
            <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img" alt="default">
                ...
                <p>Pusat pemberangkatan bus Antar Kota Antar Provinsi (AKAP) dan Antar Kota Dalam Provinsi (AKDP).</p>
                <div class="d-flex flex-wrap gap-1 mb-2">
        ...
        <div class="card card-flatty h-100">
          <div class="card-body">
            <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img" alt="default">
                ...
                <p>Gerbang utama jalur kereta api jarak jauh dan komuter (Lokal Bandung Raya).</p>
                <div class="d-flex flex-wrap gap-1 mb-2">
                  <ul class="list-unstyled mb-3">
        ...
        <div class="card card-flatty h-100">
          <div class="card-body">
            <img src="<?= BASE_UPLOAD_URL ?>default.jpg" class="card-img" alt="default">
                ...
                <p>Layanan transportasi udara yang menghubungkan Bandung dengan kota-kota lain. Penerbangan jet komersial saat ini dipusatkan di Bandara Kertajati (KJT), sementara Husein Sastranegara (BDO) melayani pesawat baling-baling (propeller) dan jet pribadi/militer.</p>
                <div class="d-flex flex-wrap gap-1 mb-2">
                  <ul class="list-unstyled mb-3">
          ...
          <div class="card-footer">
                <a
                href="https://www.google.com/maps/search/?api=1&query=bandara%20kertajati%20bdo"
                class="btn btn-primary">Lihat Maps<i class="arrow-icon fas fa-angle-right"></i>
                </a>
              </div>
          </div>
      ...
      <div class="col-12 py-5">
        <div class="bg-primary mx-auto" style="max-width: 440px">
          <h3 class="h4 mb-3 text-white">
            <i class="fas fa-lightbulb me-2"></i>
            Tips
          </h3>
          <p class="small mb-4">Informasi lebih lengkap mengenai layanan publik di Bandung bisa kamu akses disini</p>
          <a href="/trip#explore:3" class="btn btn-outline-white btn-sm">Layanan Publik<i class="arrow-icon fas fa-angle-right ms-1"></i></a>
        </div>
      </div>
    </section>
  </div>
