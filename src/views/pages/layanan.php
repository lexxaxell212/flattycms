  ...
  <div class="row g-4 py-5">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
      <div class="card card-glass">
        <div class="card-body">
          ...
          <div class="d-flex align-items-start mb-3">
            <div class="me-3">
              <h3>Stasiun Hall/Kiaracondong</h3>
    ...
    <div class="col-12 py-5">
      <div class="alert alert-primary p-4 mx-auto" style="max-width: 440px">
        ...
        <p>Gunakan <strong>Metro Jabar Trans</strong> untuk rute utama atau <strong>Ojek Online</strong> untuk kecepatan menembus kemacetan Bandung.</p>
      </div>
    </div>
  </div>
