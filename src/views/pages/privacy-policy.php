    ...
    <div class="row g-4">
      <div class="col-lg-12">
        ...
        <ul class="list-unstyled text-muted small">
          ...
          <li class="mb-2"><i class="fas fa-circle-dot me-2 text-purple"></i><strong data-bhs="privasi.s1.item2.label">Data Kunjungan</strong> <span data-bhs="privasi.s1.item2.desc">- alamat IP, jenis browser, dan halaman yang dikunjungi.</span></li>
      ...
      <div class="col-lg-12">
        ...
        <div class="badge-red border py-2 px-4 small rounded-sm d-inline-flex align-items-center gap-3">
          ...
          <span data-bhs="privasi.s2.nosell">Kami TIDAK menjual, menyewakan, atau memperdagangkan data
      ...
      <div class="col-lg-12">
        ...
        <ul class="list-unstyled text-muted small">
          ...
          <li class="mb-2"><i class="fas fa-circle-dot me-2
            text-purple"></i><strong data-bhs="privasi.s5.item3.label">Berhenti Berlangganan</strong> <span data-bhs="privasi.s5.item3.desc">- klik</span> <a
          ...
          <table class="table table-sm table-bordered text-muted small align-middle">
            <thead>
              <tr>
                ...
                <th data-bhs="privasi.s7.th.durasi">Durasi</th>
                <th data-bhs="privasi.s7.th.ket">Keterangan</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td data-bhs="privasi.s7.row1.jenis">Data akun</td>
                <td data-bhs="privasi.s7.row1.durasi">Selama aktif</td>
                <td data-bhs="privasi.s7.row1.ket">Dihapus 30 hari setelah akun ditutup</td>
              </tr>
              <tr>
                <td data-bhs="privasi.s7.row2.jenis">Log kunjungan</td>
                <td data-bhs="privasi.s7.row2.durasi">90 hari</td>
                <td data-bhs="privasi.s7.row2.ket">Dihapus otomatis</td>
              </tr>
              <tr>
                <td data-bhs="privasi.s7.row3.jenis">Data newsletter</td>
                <td data-bhs="privasi.s7.row3.durasi">Hingga unsubscribe</td>
                <td data-bhs="privasi.s7.row3.ket">Dihapus segera setelah permintaan</td>
              </tr>
              <tr>
                <td data-bhs="privasi.s7.row4.jenis">Cookie analitik</td>
                <td data-bhs="privasi.s7.row4.durasi">13 bulan</td>
                <td data-bhs="privasi.s7.row4.ket">Sesuai kebijakan Google Analytics</td>
              </tr>
            </tbody>
          </table>
        </div>
