 ...
 <div class="col-6 col-md-3">
  <div class="card border-0 shadow-sm h-100">
   <div class="card-body">
    ...
    <div class="fw-bold fs-4 text-primary cf-hit-today">
     —
    </div>
 ...
 <div class="col-6 col-md-3">
  <div class="card border-0 shadow-sm h-100">
   <div class="card-body">
    ...
    <div class="fw-bold fs-4 text-success cf-uniq-today">
     —
    </div>
    <div class="small text-muted mt-1">
     Unique visitor hari ini
 ...
 <div class="col-6 col-md-3">
  <div class="card border-0 shadow-sm h-100">
   <div class="card-body">
    ...
    <div class="fw-bold fs-4 text-warning cf-hit-week">
     —
    </div>
    <div class="small text-muted mt-1">
     Total request 7 hari
    </div>
   </div>
  </div>
 </div>
 ...
 <div class="col-6 col-md-3">
  <div class="card border-0 shadow-sm h-100">
   <div class="card-body">
    ...
    <div class="fw-bold fs-4 text-info cf-uniq-week">
     —
    </div>
    <div class="small text-muted mt-1">
     Unique visitor 7 hari
    </div>
   </div>
  </div>
 </div>
