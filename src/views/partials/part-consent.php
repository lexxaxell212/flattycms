...
<div id="consentBanner" class="mx-auto consent-banner">
  <div class="consent-header">
    ...
    <button type="button" id="btnDismissConsent" class="btn btn-sm btn-fit rounded-full shadow-none" aria-label="Close"><i class="fas fa-xmark fs-5"></i>
    </button>
  </div>
<div class="consent-body">
  ...
  <div class="d-flex gap-2 flex-wrap">
    <button id="btnAcceptConsent" class="btn btn-primary btn-fit">Terima
    </button>
    <button id="btnRejectConsent" class="btn btn-outline-primary btn-fit">Tolak
    </button>
  </div>
</div>
</div>
