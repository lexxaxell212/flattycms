    ...
    <div class="glass-hero-card col-12 col-md-7 col-lg-5">
      ...
      <div class="d-flex flex-column align-items-start gap-2">
        <a href="/trip" class="btn btn-primary mb-2">
          TRIP PLANNER <i class="arrow-icon fas fa-arrow-right ms-2"></i>
        </a>
        <a href="/things-to-do" class="btn btn-glass" style="padding-block: calc(var(--space-3) - 2px)">
          THINGS TO DO
          <i class="arrow-icon fas fa-arrow-right ms-2"></i>
        </a>
      </div>
    </div>
  </div>
