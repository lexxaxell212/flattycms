...
<div class="d-flex align-items-center mx-auto">
 <div class="auth-btn-group">
  <div id="<?= $google_btn_id ?>" class="avatar-circle">
   <i class="fa-brands fa-google"></i>
  </div>
  <div class="divider-v"></div>
  <a href="/login" class="btn btn-outline-primary btn-sm btn-fit" data-bhs="btn.login">
   Masuk
  </a>
  <a href="/register" class="btn btn-primary btn-sm btn-fit" data-bhs="btn.reg">
   Daftar
  </a>
 </div>
</div>
...
<div class="d-flex align-items-center mx-auto">
 <div class="auth-btn-group">
  ...
  <div class="divider-v"></div>
  <a href="/api/auth/logout.php" class="btn btn-outline-primary btn-sm btn-fit" data-bhs="btn.logout">
   Keluar
  </a>
 </div>
</div>
