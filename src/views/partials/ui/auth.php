...
<div class="d-flex align-items-center">
  ...
  <a href="/login" class="btn btn-outline-primary btn-sm rounded-sm">
    Masuk
  </a>
  <a href="/register" class="btn btn-primary btn-sm rounded-sm">
    Daftar
  </a>
  </div>
</div>
...
<div class="d-flex align-items-center">
  ...
  <div class="divider-v"></div>
  <a href="/api/auth/logout.php" class="btn btn-outline-primary btn-sm rounded-sm">
    Keluar
  </a>
  </div>
</div>
